...
\begin{enumerate}
    \item Choose the current item: $K(w - w_j, j - 1) + v_j \Rightarrow$ Because this round needs to place $w_j$; the previous space will be $w - w_j$ fill in.
    \item Do not choose the current item: $K(w, j - 1)$
\end{enumerate}
